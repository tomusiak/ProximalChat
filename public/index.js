...
document.addEventListener('keydown', function(event) {
    switch (event.keyCode) {
      case 65: // A
        if (online_user_x > 10 && online_user_y > 10 && online_user_y < 490) {
          movement.left = true;
          audios.forEach(song => {
        ...
        break;
      case 87: // W
        if (online_user_y > 10 && online_user_x > 10 && online_user_x < 740) {
          movement.up = true;
          audios.forEach(song => {
            (song.gain).gain.value = 62500 / (Math.pow((Math.sqrt(Math.pow(online_user_x-song.x,2)+Math.pow(online_user_y-song.y,2))),2) + 62500);
          });
        ...
        break;
      case 68: // D
        if (online_user_x < 740 && online_user_y > 10 && online_user_y < 490) {
          movement.right = true;
          audios.forEach(song => {
            (song.gain).gain.value = 62500 / (Math.pow((Math.sqrt(Math.pow(online_user_x-song.x,2)+Math.pow(online_user_y-song.y,2))),2) + 62500);
          });
        ...
        break;
      case 83: // S
        if (online_user_y < 490 && online_user_x > 10 && online_user_x < 740) {
          movement.down = true;
          audios.forEach(song => {
            (song.gain).gain.value = 62500 / (Math.pow((Math.sqrt(Math.pow(online_user_x-song.x,2)+Math.pow(online_user_y-song.y,2))),2) + 62500);
          });
